...
public class PaymentBrowserActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        layoutRoot = findViewById(R.id.layout_generic_root);
        layoutContainer = findViewById(R.id.layout_payment_browser_container);
        progressBar = layoutRoot.findViewById(R.id.progress);
