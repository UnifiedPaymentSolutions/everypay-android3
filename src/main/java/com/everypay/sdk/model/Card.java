...
public class Card implements Parcelable {
    ...
    public static final int YEAR_MAX_VALUE = 2100;
    public static final int MONTH_MIN_VALUE = 1;
    public static final int MONTH_MAX_VALUE = 12;
    public static final int EXPIRE_DATE_DIGIT_COUNT = 4;
    public static final int CVC_COUNT_AMERICAN_EXPRESS = 4;
    public static final int CVC_COUNT = 3;
